function[cropped_im1, cropped_im2] = get_cropped_image(im1,im2)

% im1 = imread('marker.JPG') ;
% %   im2 = imread('aruco-marker2.png') ;
...
pointsA = [x1_ok, y1_ok];
pointsB = [x2_ok, y2_ok];
show_correspondence(im1, im2, x1_ok, y1_ok, x2_ok, y2_ok)
...
% % im2_resized = imresize(cropped_im2, size(cropped_im1(:,:,1)));
% figure(92)
% imshow(im2_resized)
end